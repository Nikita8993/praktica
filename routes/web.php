...
Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/user/list', [HomeController::class, 'create'])->name('user.list');
    Route::post('/post', [HomeController::class, 'store'])->name('post.store');
});

//Маршрут доступен только Администратору
Route::get('/main', [MainController::class, 'index'])->name('main.index');
// Создайте кнопку Main в layout.blade.php чтобы перейти по данному маршруту
